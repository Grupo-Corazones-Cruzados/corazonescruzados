...
export default function MiembroTicketDetailPage() {
    ...
    return (
      <DashboardLayout>
        <div className={styles.detailPage}>
          <Link href="/dashboard/miembro/tickets" className={styles.backButton}>
            <ArrowLeftIcon />
        ...
        <div className={styles.detailGrid}>
          ...
          <div className={styles.detailMain}>
            ...
            <div className={styles.detailCard}>
              ...
              {ticket.detalle && (
                <div style={{ marginTop: "var(--space-4)" }}>
                  <h4 className={styles.detailCardTitle}>Descripcion</h4>
            ...
            {ticket.google_meet_link && (
              <div className={styles.detailCard}>
                <h4 className={styles.detailCardTitle}>Reunion</h4>
                <a
