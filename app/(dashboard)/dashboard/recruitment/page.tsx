...
type TabValue = "applicants" | "events";
...
export default function RecruitmentPage() {
  ...
  const [tab, setTab] = useState<TabValue>("applicants");

  return (
    <div>
      <PageHeader
        title="Reclutamiento"
        description="Gestiona aspirantes y eventos de reclutamiento."
      />

      <Tabs
        tabs={[
          { value: "applicants", label: "Aspirantes" },
