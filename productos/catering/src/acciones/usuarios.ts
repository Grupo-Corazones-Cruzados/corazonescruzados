...
const Alta = z.object({
  ...
  rol: z.enum(['ADMIN', 'COCINA', 'DESPACHO']),
...
export async function editarUsuario(
  ...
  const rol = String(datos.get('rol') || cuenta.rol) as 'ADMIN' | 'COCINA' | 'DESPACHO';
  ...
  // Y tampoco puede quedarse el negocio sin ningún administrador activo.
