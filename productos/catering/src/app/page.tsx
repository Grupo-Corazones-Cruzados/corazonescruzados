    ...
    <main className="flex min-h-screen items-center justify-center bg-fondo px-4">
      <div className="tarjeta w-full max-w-md p-8 text-center">
        <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-acento-suave">
          <Salad className="h-6 w-6 text-acento" />
        </div>
        <h1 className="text-[20px] font-semibold text-texto">Gestión de Catering</h1>
        <p className="mt-2 text-[13px] leading-relaxed text-tenue">
          Comida por suscripción a domicilio: clientes, servicios por días, menú, etiquetas y
          rutas de reparto. Cada negocio entra por su propia dirección: usa el enlace que te
          dieron, termina en{' '}
