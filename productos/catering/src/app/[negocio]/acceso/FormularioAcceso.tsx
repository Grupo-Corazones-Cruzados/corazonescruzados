  ...
  return (
    <form action={enviar} className="space-y-3">
      <Campo etiqueta="Usuario o correo">
        <Entrada name="usuario" autoComplete="username" autoFocus required placeholder="El personal entra con su usuario; los clientes, con su correo" />
      </Campo>
      ...
      <p className="pt-1 text-center text-[11px] leading-relaxed text-tenue">
        ¿Olvidaste tu contraseña? Pídesela al negocio: pueden generarte una nueva.
      </p>
    </form>
  );
}
