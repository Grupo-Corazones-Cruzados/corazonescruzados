 ...
 *  - la de una persona del hotel   → cookie `reservas_sesion`, lleva su inquilino;
 *  - la de quien opera el producto → cookie `reservas_gcc`.
...
export const COOKIE_SESION = 'reservas_sesion';
/**
...
/** ADMIN lo puede todo; GERENTE opera; CONSULTA solo mira. */
const PESO: Record<RolUsuario, number> = { CONSULTA: 0, GERENTE: 1, ADMIN: 2 };
export const alMenos = (rol: RolUsuario, minimo: RolUsuario) => PESO[rol] >= PESO[minimo];
