// Worker del AGENTE IA de WhatsApp — del producto «Automatizaciones».
//
// Servicio de larga vida: no es un cron. Es copia del de la plataforma, apuntando a este
// producto; cuando se apague el de allí, este es el único.
//
