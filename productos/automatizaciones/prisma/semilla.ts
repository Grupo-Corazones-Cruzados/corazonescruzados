...
async function main() {
  // EL PLAN. Fernando lo fijó el 2026-09-23: **5 $/mes con las tres cosas dentro**
  // —agente de IA, campañas de correo y campañas de WhatsApp—. No se cobran por separado.
  const plan = await prisma.plan.upsert({
    where: { slug: 'estandar' },
    update: { precioMensual: 5, nombre: 'Estándar' },
    create: {
      slug: 'estandar',
      nombre: 'Estándar',
      descripcion:
