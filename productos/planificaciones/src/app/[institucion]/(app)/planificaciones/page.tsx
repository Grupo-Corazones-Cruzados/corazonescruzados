  ...
  if (pId && !elegida) {
    ...
    if (p)
      extra = {
        ...
        registroTitulo: p.registroTitulo, registroElaboradoCargo: p.registroElaboradoCargo, registroElaboradoNombre: p.registroElaboradoNombre, registroElaboradoFecha: p.registroElaboradoFecha, registroAprobadoCargo: p.registroAprobadoCargo, registroAprobadoNombre: p.registroAprobadoNombre, registroAprobadoFecha: p.registroAprobadoFecha, deceNombre: p.deceNombre, numeroSemanas: p.numeroSemanas,
