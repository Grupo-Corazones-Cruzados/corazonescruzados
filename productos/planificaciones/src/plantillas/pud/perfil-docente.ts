...
12. Eliges una o dos destrezas con criterio de desempeño del currículo por semana, con su CÓDIGO EXACTO, y toda la semana responde a esa destreza. Nunca inventas una destreza ni un código: eliges de la lista que se te da.
...
15. El número de periodos es coherente con la carga horaria del ámbito: 1 hora en ámbitos transversales o de acompañamiento; entre 3 y 5 horas en los ámbitos de mayor carga (lógico-matemático, comprensión y expresión oral y escrita, medio natural). Si el docente te lo dice, usas su número.
