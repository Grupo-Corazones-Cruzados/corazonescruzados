...
ESCENAS = [
    ...
    (87, ["assets/Prologo/escenas/escena_86.png", "assets/Prologo/escenas/escena_64.png"],
        "MISMO LUGAR, MISMA PALETA y MISMO ESTILO que las referencias: el borde del Hoyo, tierra "
        "clara y agrietada, raíces secas y retorcidas alrededor, luz gris ceniza, pixel-art 2D "
        "de siluetas planas y sombreado por zonas. "
        "ES UN PLANO SUBJETIVO (POV) DEL HERMANO MAYOR MIRANDO HACIA ABAJO: la cámara son SUS "
        "OJOS y está asomado al borde, con la vista clavada en el fondo del agujero. Por eso: "
        "(1) LA BOCA NEGRA DEL HOYO OCUPA CASI TODO EL CUADRO: un enorme vacío OSCURO que se "
        "abre justo debajo, del que no se ve el fondo. La negrura se va cerrando hacia el "
        "centro, cada vez más profunda, sin nada reconocible dentro. Es lo que él está mirando. "
        "(2) EL BORDE, arriba y a los lados del encuadre: la franja de tierra agrietada del "
        "labio del agujero, con las raíces secas asomando y algún terrón suelto desprendiéndose "
        "y cayendo hacia la oscuridad. "
        "(3) SUS PROPIOS PIES, abajo del todo: en el BORDE INFERIOR del cuadro se ven las "
        "PUNTAS de sus dos zapatos, en fuerte ESCORZO desde arriba, pisando el mismísimo canto "
        "del borde con parte de la suela ya en el aire. Se ve muy poco de sus piernas, solo lo "
        "justo. Siluetas oscuras planas. PROHIBIDO dibujar pies gigantes, deformes o vistos de "
        "lado: se ven DESDE ARRIBA, como los vería él. "
        "(4) SUS HERMANOS SIGUEN AGARRADOS A ÉL: por los DOS bordes laterales del cuadro, a la "
        "altura de su cintura, asoman los BRAZOS y las MANOS pequeñas de sus dos hermanitos "
        "rodeándolo y aferrándose a él, en silueta oscura. Solo se ven esos brazos y manos, no "
        "sus cuerpos: están detrás de él, fuera de cuadro. Así se entiende que no está solo. "
        "LO QUE TIENE QUE TRANSMITIR: la DUDA. Está parado en el filo, mirando el vacío, sin "
        "decidirse todavía. Quietud, vértigo y silencio: nadie ha saltado aún, nadie está "
        "cayendo. PROHIBIDO que haya figuras en el aire o cayendo. "
        "PROHIBIDO que aparezca ninguna cara, ninguna otra persona y ninguna figura granate. "
        "NADA de texto."),
