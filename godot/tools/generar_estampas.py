...
ESCENAS = [
    ...
    (68, ["assets/Prologo/escenas/escena_67.png", "hoyo"],
        ...
        "la espalda que la cara). El grupo va en fila hacia el lado derecho: los primeros ya "
        "están MUY CERCA del borde DERECHO del cuadro (alguno medio saliendo por la derecha), "
        "y los últimos aún a media distancia. La MITAD IZQUIERDA de la imagen queda "
