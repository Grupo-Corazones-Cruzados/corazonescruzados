...
ESCENAS = [
    ...
    (69, ["assets/Prologo/escenas/escena_68.png",
        ...
        "PROHIBIDO TAMBIÉN que nada arranque de la ESQUINA INFERIOR DERECHA: esa esquina queda "
        "como hierba vacía, sin figuras y sin ningún elemento que salga de ahí en diagonal. "
        ...
        "luz AMARILLA cálida, de apenas unos píxeles, que son los únicos puntos cálidos de "
        "toda la imagen. PROHIBIDO dibujarlas grandes, cercanas, iluminadas por completo o con "
        "detalle arquitectónico: tienen que quedar PEQUEÑÍSIMAS y lejanas, como en la "
        "referencia. Es adonde va la gente. "
        ...
        "o arrodillada. "
        "REPARTO — LA GENTE YA ESTÁ EN LA ZONA IZQUIERDA, LLEGANDO: el grueso de las figuras "
        "se concentra en la MITAD IZQUIERDA del cuadro, ya cerca del poblado, y sigue "
        "avanzando hacia él. DOS O TRES figuras están a punto de entrar entre las primeras "
        "casas, diminutas por la distancia; otras cuantas van algo más atrás pero también en "
        "esa mitad izquierda; y como mucho UNA o DOS quedan rezagadas hacia el centro, NUNCA "
        "en la mitad inferior derecha. Van DISPERSAS y DESORDENADAS, NUNCA en fila, NUNCA "
        ...
        "La MITAD DERECHA del cuadro queda como campo abierto y vacío: es de donde vienen, y "
        "ahí ya no queda casi nadie. "
