...
ESCENAS = [
    ...
    (78, ["assets/Prologo/escenas/escena_76.png",
        ...
        "cargando MOCHILAS de tela, hatillos atados con cuerda y mantas enrolladas; uno lleva un "
        "bulto al hombro y otro un bastón de caminante. Van ESCALONADOS por la distancia: los "
        "dos primeros ya casi en el horizonte y DIMINUTOS, dos a media distancia, y dos aún "
        "cerca de la bifurcación. El ÚLTIMO de todos ha GIRADO LA CABEZA hacia atrás, mirando "
        "el pueblo por encima del hombro, sin dejar de caminar. "
        ...
        "trazo simple. "
        "Que el contraste quede claro: un grupo QUIETO y de espaldas abajo, y una fila que se "
        "ALEJA y se va empequeñeciendo hacia el humo. "
