...
ESCENAS = [
    ...
    (6, ["assets/Prologo/escenas/escena_06.png", "assets/Prologo/escenas/escena_05.png"],
        "CONSERVA la PRIMERA imagen de referencia tal cual, cambiando SOLO dónde está el Hoyo. "
        "Todo lo demás IDÉNTICO a esa primera referencia: el mismo amanecer frío y neblinoso, "
        "el mismo campo marchito y amarillento con sus calvas y malezas secas, los mismos "
        "matorrales secos del borde inferior, el mismo sol pálido en el mismo punto del "
        "horizonte, la misma paleta apagada, el mismo estilo de dibujo y la misma escala de "
        "figura. "
        "⚠ EL ÚNICO CAMBIO — DÓNDE Y DE QUÉ TAMAÑO VA EL HOYO. En la primera referencia está "
        "MAL: aparece desplazado a la DERECHA y demasiado grande. Tiene que quedar EXACTAMENTE "
        "como en la SEGUNDA imagen de referencia, y esto es lo más importante de la petición: "
        "• POSICIÓN: PERFECTAMENTE CENTRADO en horizontal. El centro del agujero cae justo "
        "sobre el EJE VERTICAL de la imagen, a la misma distancia del borde izquierdo que del "
        "derecho, igual que en la segunda referencia. Y algo MÁS ABAJO que en la primera "
        "referencia: su centro queda por debajo de la mitad del alto de la imagen. "
        "• TAMAÑO: MÁS PEQUEÑO que en la primera referencia. Debe ocupar aproximadamente el "
        "MISMO ancho que en la segunda referencia, es decir, alrededor de UN TERCIO del ancho "
        "total del cuadro, no la mitad. "
        "• FORMA: la misma elipse ancha y achatada de agujero natural oscuro (SIN muros de "
        "piedra, SIN ladrillos, SIN borde construido). "
        "Donde antes estaba el agujero, a la derecha, ahora solo hay campo marchito. "
