...
ESCENAS = [
    ...
    (53, ["assets/Prologo/escenas/escena_53.png", "assets/Prologo/escenas/escena_55.png"],
        ...
        "⚠ ALTURAS — corrige esto respecto a la referencia, donde los tres grandes salen casi "
        "iguales: PAPÁ y MAMÁ son los MÁS ALTOS de la familia y miden lo mismo entre ellos. El "
        "HERMANO MAYOR (personaje principal) es un ADOLESCENTE y tiene que verse CLARAMENTE "
        "MÁS BAJO que ellos: le llega a los padres POR LOS HOMBROS, o sea que mide alrededor "
        "de CUATRO QUINTOS de su altura. CÓMO COMPROBARLO: si trazas una línea horizontal por "
        "encima de la cabeza de un padre, la cabeza del hermano mayor queda CLARAMENTE POR "
        "DEBAJO de esa línea, con un HUECO BIEN VISIBLE entre una cabeza y otra, del grosor de "
        "media cabeza. Si sus cabezas quedan a la misma altura, está MAL. La diferencia debe "
        "notarse de un vistazo en las "
        "siluetas. PROHIBIDO que salga casi tan alto como los padres o que los tres parezcan "
        "de la misma estatura. Aun así sigue siendo MUCHO MÁS ALTO que los dos hermanitos. "
        "Y DOS HERMANITOS MUY PEQUEÑOS y bajitos (siluetas chiquitas, que le llegan al hermano "
        "mayor por la cintura). MUY IMPORTANTE sobre el "
