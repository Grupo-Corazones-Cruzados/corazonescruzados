...
ESCENAS = [
    ...
    (72, ["assets/Prologo/escenas/escena_70.png",
        ...
        "EL LUGAR: el DORMITORIO DE LOS PADRES, otro cuarto de esa misma casa, de noche. Mismos "
        "materiales que la segunda referencia: pared de LADRILLO visto de tono tierra, VIGAS de "
        "madera en el techo, suelo de tablones. Pero es OTRA habitación: la CAMA es GRANDE, de "
        "MATRIMONIO, con cabecero de madera y una manta de lana de retales. PROHIBIDO que "
        "aparezca la cama pequeña de la niña. "
        "PROHIBIDO que aparezca NINGÚN NIÑO ni NINGUNA NIÑA: en la escena están SOLO los dos "
        "adultos, nadie más. "
        "LA ESCENA — LOS DOS ABRAZADOS, y esto es lo que tiene que leerse de un vistazo: están "
        "DE PIE junto a la cama, UNO FRENTE AL OTRO y muy juntos, ABRAZÁNDOSE: los brazos de él "
        "rodean la espalda de ella y los de ella rodean el cuello o los hombros de él; los "
        "cuerpos se tocan y las cabezas están MUY CERCA, casi frente con frente, ambos con los "
        "OJOS CERRADOS y una SONRISA serena. PROHIBIDO que salgan separados, de pie sin "
        "tocarse, sentados en la cama charlando, de espaldas o mirando al espectador: tiene que "
        "ser un ABRAZO claro, de pareja. "
        "LOS BOCADILLOS — es el ÚNICO texto que debe haber en toda la imagen: DOS bocadillos "
        "pequeños de diálogo, uno saliendo de cada uno de los dos, cada uno con las MISMAS DOS "
        "PALABRAS: \"TE AMO\". Letras claras, en mayúsculas, cortas y bien legibles. NADA MÁS "
        "escrito en la imagen: ni carteles, ni firmas, ni otras frases. "
        "DETALLES DE LA HABITACIÓN: un taburete o mesita de madera junto a la cama con un "
        "QUINQUÉ de aceite encendido, que da la única luz cálida y naranja del cuarto; una "
        "VENTANA con cortinas de tela por la que se ve la NOCHE azul oscura con la luna y "
        "estrellas; un arcón de madera, una silla con ropa doblada y un pequeño espejo o un "
        "marco sencillo en la pared. "
        "PROHIBIDO ABSOLUTAMENTE cualquier cosa eléctrica o electrónica: NI bombillas, NI "
        "lámparas eléctricas, NI cables, NI enchufes, NI pantallas, NI aparatos. Solo aceite, "
        "vela y madera. "
