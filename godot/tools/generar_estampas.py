...
ESCENAS = [
    ...
    # ⚠ DOS REFERENCIAS, cada una para una cosa (reglas §4.25 y §4.31: una imagen
    # gana a cualquier descripción, pero hay que decir QUÉ copiar y qué NO).
    # Historial: encadenar la 97 con "conserva todo" daba los cuerpos ENTEROS
    # (3 tiradas); generar de cero SIN referencia dio por fin el desgrane, pero
    # perdió la escala, el fondo y las siluetas negras. Las dos mitades buenas
    # se guardaron en `referencias/` y aquí se combinan.
    (115, ["assets/Prologo/referencias/115_encuadre.png",
           "assets/Prologo/referencias/115_desgrane.png"],
        "Dibuja UNA sola ilustración combinando las dos imágenes de referencia. "
        "⚠ DE LA PRIMERA IMAGEN copia TODO lo que define la escena y NO se toca: el estilo "
        "PIXEL ART 2D de 16 bits con sombreado plano y dithering, el encuadre horizontal 16:9, "
        "el interior del pozo con la pared de roca cuarteada OSCURA cubriendo todo el fondo, "
        "el halo de luz gris del centro, la penumbra que cierra las esquinas, las rayas finas "
        "de arrastre y las motas subiendo, y sobre todo LA ESCALA Y LA PALETA: las tres "
        "figuras son SILUETAS NEGRAS MACIZAS Y PLANAS, pequeñas y lejanas, ocupando apenas una "
        "QUINTA PARTE del alto del cuadro, en el centro del halo. Monocromo de grises fríos. "
        "PROHIBIDO ABSOLUTAMENTE agrandar las figuras, acercar la cámara, aclarar el fondo o "
        "dibujarles ropa clara, camisetas blancas, caras, ojos o cualquier detalle interior: "
        "son manchas negras planas. "
        "⚠ DE LA SEGUNDA IMAGEN copia SOLO UNA COSA: CÓMO SE ESTÁN DESHACIENDO LAS FIGURAS. "
        "NO copies su escala, ni su fondo claro, ni su ropa blanca, ni su encuadre. Solo el "
        "efecto: las CABEZAS se han desintegrado y en su lugar sube una nube de motas negras "
        "que se dispersa; la parte de abajo de los cuerpos se deshilacha hacia abajo en un "
        "enjambre de puntos negros; hay trozos sueltos, pequeños y girados, flotando "
        "separados del cuerpo; y los bordes que quedan se disuelven en cuadraditos negros de "
        "unos pocos píxeles con estelas finas, como ceniza. "
        "⚠ LO ÚNICO QUE SIGUE ENTERO SON LOS DOS BRAZOS QUE SE DAN LA MANO, Y ES LO MÁS "
        "IMPORTANTE: el brazo que baja del hombro de la figura del centro hasta la manita de "
        "la pequeña de la izquierda, y el que baja hasta la de la derecha. Conservan su FORMA "
        "NATURAL DE BRAZO, con el contorno limpio y cerrado, sin una sola mota suelta, y las "
        "manos siguen agarradas. PROHIBIDO dibujar una BARRA, un palo o una franja recta que "
        "cruce el cuadro: son brazos. PROHIBIDO que se rompan o se desgranen. "
        "⚠ SIGUEN SIENDO EXACTAMENTE TRES, NI UNA MÁS: la alta en el centro y DOS pequeñas, "
        "una a cada lado. La pequeña de la IZQUIERDA es la única con falda acampanada y "
        "coletas; la de la DERECHA tiene silueta recta de pantalón y pelo corto. La del CENTRO "
        "es un personaje NEUTRO, ni hombre ni mujer (es la regla más importante del juego): "
        "cuerpo recto y estrecho, camiseta suelta que cae recta, pantalón con las dos piernas "
        "separadas, pelo corto. PROHIBIDO ABSOLUTAMENTE dibujarle falda, vestido, pelo largo, "
        "melena, coletas, cintura estrechada, caderas anchas o pecho. "
        "La lectura correcta es: 'de las tres figuras ya casi no queda nada, se están yendo en "
        "polvo, y solo las manos siguen agarradas'. No hay suelo. PROHIBIDO añadir figuras o "
        "elementos nuevos, PROHIBIDO cualquier color que no sea gris, y PROHIBIDO cualquier "
        "texto."),
]
