...
ESCENAS = [
    ...
    (6, ["assets/Prologo/escenas/escena_06.png", "assets/Prologo/escenas/escena_05.png"],
        ...
        "figura. "
        "⚠ EL ÚNICO CAMBIO — LA POSICIÓN DEL HOYO: en la primera referencia el Hoyo está "
        "desplazado hacia la DERECHA del encuadre. Colócalo EXACTAMENTE donde está en la "
        "SEGUNDA imagen de referencia: CENTRADO horizontalmente en la imagen y a esa misma "
        "altura, con el MISMO TAMAÑO grande que tiene ahora. Es el mismo agujero natural "
        "oscuro (SIN muros de piedra, SIN ladrillos). Rellena con campo marchito el sitio de "
        "la derecha donde antes estaba. "
