...
ESCENAS = [
    ...
    (53, ["assets/Prologo/escenas/escena_55.png", "assets/Prologo/escenas/escena_54.png"],
        ...
        "ambos lados, escombros y cascotes en primer plano, bruma y cielo plomizo. "
        ...
        "seis. "
        "⚠⚠ TODOS HUYEN, NADIE SE ENFRENTA: las CINCO figuras de la familia corren HACIA LA "
        "IZQUIERDA, de ESPALDAS a los perseguidores, con los cuerpos y las piernas "
        "orientados a la izquierda y la cabeza mirando en esa misma dirección. PROHIBIDO "
        "ABSOLUTAMENTE que alguna de ellas corra hacia la derecha, se gire hacia los "
        "perseguidores, los encare o se quede plantada frente a ellos: están escapando y "
        "tienen miedo, no se defienden. Si alguna figura de la familia mira o avanza hacia "
        ...
        "de la altura de un adulto, y le llegan al hermano mayor por la CINTURA. Son claramente "
        "los más bajitos, con cabezas grandes respecto a su cuerpecito. "
        ...
        "⚠⚠ A LA DERECHA, LOS PERSEGUIDORES — SON OBLIGATORIOS Y NO PUEDEN FALTAR: TRES "
        "siluetas de color ROJO-GRANATE oscuro (maroon), bien visibles y del mismo tamaño "
        "ADULTO GRANDE, las figuras más corpulentas de toda la escena. Ocupan la MITAD DERECHA "
        "del cuadro, a la misma distancia de cámara que la familia y del mismo tamaño en "
        "pantalla que los padres. CORREN hacia la IZQUIERDA persiguiéndolos, con zancadas "
        "largas, el cuerpo lanzado hacia delante y los brazos estirados, feroces. CADA UNO DE "
        "LOS TRES LLEVA UN ARMA BLANCA EN LA MANO: un cuchillo o machete de HOJA BLANCA bien "
        "visible, en alto o apuntando hacia delante. Los tres armados, sin excepción. "
        "Su color granate es el ÚNICO color de la imagen y tiene que destacar sobre el gris. "
        "PROHIBIDO que la mitad derecha quede vacía, que los perseguidores falten, que salgan "
        "diminutos o al fondo perdidos, o que se mezclen con la familia. Si al terminar no hay "
        "TRES figuras granate grandes persiguiendo, la imagen está MAL. "
