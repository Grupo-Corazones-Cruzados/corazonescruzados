...
ESCENAS = [
    ...
    (68, ["assets/Prologo/escenas/escena_67.png", "hoyo"],
        ...
        "de puntos del cielo de la referencia. La luz "
        ...
        "ALEJÁNDOSE del Hoyo y SALIENDO DEL ENCUADRE HACIA LA DERECHA. "
        "DIRECCIÓN OBLIGATORIA: todo el mundo avanza HACIA LA DERECHA de la imagen, con el "
        "cuerpo orientado a la derecha, vistos de espaldas y de tres cuartos (se les ve más "
        "la espalda que la cara). "
        "REPARTO — MUY IMPORTANTE, NADA DE FILAS: la gente va DISPERSA y DESORDENADA por el "
        "campo, NO alineada. PROHIBIDO que las figuras queden en una FILA, en una hilera "
        "horizontal, a la misma altura o formando una procesión ordenada. Cada grupo va a SU "
        "aire, a DISTINTA ALTURA dentro del campo (unos más abajo, cerca del primer plano; "
        "otros más arriba, hacia el fondo) y a DISTINTA DISTANCIA entre sí, con huecos "
        "grandes e irregulares de hierba vacía entre unos y otros. "
        "UNOS VAN MUY ADELANTADOS Y OTROS MUY REZAGADOS: DOS O TRES figuras ya están SALIENDO "
        "del encuadre por el BORDE DERECHO, CORTADAS por el marco (se les ve solo media "
        "figura, o solo un brazo y una pierna asomando); otras van por el medio del campo; y "
        "un par van muy atrás, todavía cerca del Hoyo. La MITAD IZQUIERDA de la imagen queda "
        "prácticamente vacía de gente. NADIE camina hacia la izquierda. "
        ...
        "sentada, arrodillada o rezando. Si una figura no está caminando hacia la derecha, "
        "está MAL. "
        ...
        "(a) TRES grupos familiares, todos caminando hacia la derecha en zancada: en uno, un "
        ...
        "hacia la derecha; UNO de esos dos niños ha GIRADO LA CABEZA hacia atrás (hacia la "
        "IZQUIERDA), MIRANDO el Hoyo por encima del hombro mientras SIGUE caminando hacia la "
        "derecha (es el único que todavía lo mira, y aun así se está yendo). "
